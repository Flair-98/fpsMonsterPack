class InfernalGreen extends Monster config (fpsMonsterPack);
...
{       local vector EffectPos;
  ...
  FireEmitter0 = Spawn(class'InfernalGreenFlame',,,Effectpos);
  AttachToBone(FireEmitter0, 'Spine3');
}

simulated function SpawnLeftLeg()
{
  FireEmitter1 = Spawn(class'InfernalGreenFlame');
  AttachToBone(FireEmitter1, 'LeftLeg');
}

simulated function SpawnRightLeg()
{
  FireEmitter2 = Spawn(class'InfernalGreenFlame');
...
simulated function SpawnLeftArm()
{
  ...
  FireEmitter3 = Spawn(class'InfernalGreenFlame');
...
simulated function SpawnRightArm()
{
  ...
  FireEmitter4 = Spawn(class'InfernalGreenFlame');
...
simulated function SpawnCrotch()
{
  ...
  FireEmitter5 = Spawn(class'TinyGreenFlame');
  AttachToBone(FireEmitter5, 'RightThigh');


  FireEmitter6 = Spawn(class'TinyGreenFlame');
...
simulated function SpawnBodyFlame()
{
  ...
  BodyFlame = Spawn(class'HugeGreenFlame',self);
...
function SpawnLeftShotBig()
{
	...
	Spawn(class'SeekingInfernalProjectile',,,FireStart,FireRotation);
}
...
function SpawnLeftShot()
{
	...
	FireStart = GetFireStart(X,Y,Z);
	FireRotation = Controller.AdjustAim(SavedFireProperties,FireStart,600);
	Spawn(class'InfernalProjectile',,,FireStart,FireRotation);
}
...
defaultproperties
{
     ...
     AmmunitionClass=Class'fpsMonsterPack.InfernalAmmo'
     ScoringValue=8
