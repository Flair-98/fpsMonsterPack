class GreenExplosion extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=15,G=255,R=5))
     ...
     End Object
     Emitters(0)=SpriteEmitter'fpsMonsterPack.GreenExplosion.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000)
         ColorScale(2)=(RelativeTime=0.660000,Color=(G=255,R=5,A=190))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=60
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(1)=SpriteEmitter'fpsMonsterPack.GreenExplosion.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         AutomaticInitialSpawning=False
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000,Color=(G=255,R=6,A=100))
         ColorScale(2)=(RelativeTime=0.660000,Color=(G=255,R=8,A=255))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=150
         StartLocationShape=PTLS_Sphere
     ...
     End Object
     Emitters(2)=SpriteEmitter'fpsMonsterPack.GreenExplosion.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(3)=SpriteEmitter'fpsMonsterPack.GreenExplosion.SpriteEmitter3'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter0
         ...
         UseRegularSizeScale=False
         AutomaticInitialSpawning=False
         ColorScale(1)=(RelativeTime=0.300000,Color=(B=5,G=255,R=7))
         ColorScale(2)=(RelativeTime=0.600000,Color=(B=7,G=255,R=6))
         ColorScale(3)=(RelativeTime=1.000000)
         ...
         Texture=Texture'fpsMonTex.Weapons.greenwave'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=1.000000,Max=1.000000)
         InitialDelayRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(4)=MeshEmitter'fpsMonsterPack.GreenExplosion.MeshEmitter0'
     ...
     Begin Object Class=MeshEmitter Name=MeshEmitter1
         ...
         UniformSize=True
         AutomaticInitialSpawning=False
         ColorScale(1)=(RelativeTime=0.300000,Color=(B=2,G=255,R=5,A=255))
         ColorScale(2)=(RelativeTime=0.600000,Color=(B=2,G=255,R=5,A=128))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeOutStartTime=1.000000
         FadeInEndTime=0.100000
         MaxParticles=1
     ...
     End Object
     Emitters(5)=MeshEmitter'fpsMonsterPack.GreenExplosion.MeshEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         ColorScale(1)=(RelativeTime=0.600000,Color=(B=6,G=255,R=5))
         ColorScale(2)=(RelativeTime=0.800000,Color=(B=2,G=255,R=7))
         ColorScale(3)=(RelativeTime=1.000000)
         MaxParticles=2
         SizeScale(0)=(RelativeSize=0.200000)
     ...
     End Object
     Emitters(6)=SpriteEmitter'fpsMonsterPack.GreenExplosion.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         LifetimeRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(7)=SpriteEmitter'fpsMonsterPack.GreenExplosion.SpriteEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(8)=SpriteEmitter'fpsMonsterPack.GreenExplosion.SpriteEmitter6'
     ...
     End Object
     Emitters(9)=MeshEmitter'fpsMonsterPack.GreenExplosion.MeshEmitter2'
