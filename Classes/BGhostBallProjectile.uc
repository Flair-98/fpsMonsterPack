class BGhostBallProjectile extends Projectile; 
...
simulated function PostBeginPlay()
{
    ...
    {
		SparkleTrail = Spawn(class'fpsMonsterPack.bghostballsparkles', self);
...
defaultproperties
{
     ...
     Texture=Texture'shock_core'
     DrawScale=0.050000
     Skins(0)=Texture'shock_core'
     Style=STY_Translucent
     SoundVolume=255
     SoundRadius=6.000000
}
