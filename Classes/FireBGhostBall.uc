class FireBGhostBall extends Gasbag;

event PostBeginPlay()
{
	Super.PostBeginPlay();
	MyAmmo.ProjectileClass = class'FireBProjectile';
}
...
simulated function PlayDying(class<DamageType> DamageType, vector HitLoc)
{
    ...
    bTearOff = true;
    bPlayedDeath = true;
    Spawn(class'fpsMonsterPack.FireExplosion'); //replace xEmitter with the class of the effect you want, for example: class'ShockComboCore' 
...
defaultproperties
{
     ...
     PrePivot=(X=4.000000,Y=4.000000,Z=-5.000000)
     Mass=1400.000000
     drawscale=4
     bDynamicLight=True
     LightType=LT_Steady
