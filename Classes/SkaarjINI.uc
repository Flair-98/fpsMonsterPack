class SkaarjINI extends MonsterINI;

var sound FootStep[2];
var name DeathAnim[4];

simulated function PlayVictory()//////
{
...
{
	if (MeleeDamageTarget(10, (30000 * Normal(Controller.Target.Location - Location))) )
		PlaySound(sound'clawhit1s', SLOT_Interact);		
}

function ClawDamageTarget()
{
	if ( MeleeDamageTarget(10, (25000 * Normal(Controller.Target.Location - Location))) )
		PlaySound(sound'clawhit1s', SLOT_Interact);			
}
