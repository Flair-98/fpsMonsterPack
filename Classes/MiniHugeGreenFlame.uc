class MiniHugeGreenFlame extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=2,G=200,R=2,A=255))
         Opacity=0.100000
         ...
         StartSizeRange=(X=(Min=133.000000,Max=84.000000))
         Texture=Texture'EmitterTextures.MultiFrame.LargeFlames-grey'
         TextureUSubdivisions=4
         TextureVSubdivisions=4
         LifetimeRange=(Min=1.000000,Max=1.300000)
     End Object
     Emitters(0)=SpriteEmitter'fpsMonsterPack.MiniHugeGreenFlame.SpriteEmitter6'
