class FireTrailEffect extends Emitter;
...
defaultproperties
{
     Begin Object Class=TrailEmitter Name=TrailEmitter0
         ...
         ColorScale(0)=(Color=(B=10,G=200,R=25))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=10,G=200,R=25))
         Opacity=0.500000
         MaxParticles=1
     ...
     End Object
     Emitters(0)=TrailEmitter'fpsMonsterPack.FireTrailEffect.TrailEmitter0'
     ...
     End Object
     Emitters(1)=SpriteEmitter'fpsMonsterPack.FireTrailEffect.SpriteEmitter22'
