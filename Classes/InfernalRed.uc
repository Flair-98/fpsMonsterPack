class InfernalRed extends Monster config (fpsMonsterPack);
...
{       local vector EffectPos;
  ...
  FireEmitter0 = Spawn(class'InfernalRedFlame',,,Effectpos);
  AttachToBone(FireEmitter0, 'Spine3');
}

simulated function SpawnLeftLeg()
{
  FireEmitter1 = Spawn(class'InfernalRedFlame');
  AttachToBone(FireEmitter1, 'LeftLeg');
}

simulated function SpawnRightLeg()
{
  FireEmitter2 = Spawn(class'InfernalRedFlame');
...
simulated function SpawnLeftArm()
{
  ...
  FireEmitter3 = Spawn(class'InfernalRedFlame');
...
simulated function SpawnRightArm()
{
  ...
  FireEmitter4 = Spawn(class'InfernalRedFlame');
...
simulated function SpawnCrotch()
{
  ...
  FireEmitter5 = Spawn(class'TinyRedFlame');
  AttachToBone(FireEmitter5, 'RightThigh');


  FireEmitter6 = Spawn(class'TinyRedFlame');
...
simulated function SpawnBodyFlame()
{
  ...
  BodyFlame = Spawn(class'HugeRedFlame',self);
...
function SpawnLeftShotBig()
{
	...
	Spawn(class'SeekingInfernalProjectileRed',,,FireStart,FireRotation);
}
...
function SpawnLeftShot()
{
	...
	FireStart = GetFireStart(X,Y,Z);
	FireRotation = Controller.AdjustAim(SavedFireProperties,FireStart,600);
	Spawn(class'InfernalProjectileRed',,,FireStart,FireRotation);
}
...
defaultproperties
{
     ...
     ProjectileSpeed=6000.000000
     ProjectileMaxSpeed=6000.000000
     MonsterName="InfernalRed"
     bNoTeleFrag=True
     bNoCrushVehicle=True
     ReducedDamPct=0.250000
     WeakDamPct=0.500000
     BlastDamage=2000.000000
     ...
     AmmunitionClass=Class'fpsMonsterPack.InfernalAmmoRed'
     ScoringValue=8
