class FireMantaGhostBall extends Gasbag;


event PostBeginPlay()
{
	Super.PostBeginPlay();
	MyAmmo.ProjectileClass = class'FireMantaProjectile';
}
...
defaultproperties
{
     ...
     CollisionRadius=71.250000
     PrePivot=(X=17.500000,Y=0.000000,Z=-15.000000)
     Mass=1000.000000
     drawscale=3
     bDynamicLight=True
     LightType=LT_Steady
     ...
     Alertness=500000.000000
     PeripheralVision=500000.000000
     SkillModifier=50
