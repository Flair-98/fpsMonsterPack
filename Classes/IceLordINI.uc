class IceLordINI extends Monster config(fpsMonsterPack);
...
defaultproperties
{
     ...
     AmmunitionClass=Class'fpsMonsterPack.AtomicAmmo'
     ScoringValue=10
     bCanFly=True
     ...
     Skins(0)=FinalBlend'fpsMonTex.Skins.icelordfinal'
     Skins(1)=FinalBlend'fpsMonTex.Skins.icelordfinal'
