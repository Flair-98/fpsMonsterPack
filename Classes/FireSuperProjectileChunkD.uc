class FireSuperProjectileChunkD extends Projectile;
...
var int ChunkNumber;
var byte FlockIndex;
var FireSuperProjectileChunkD Flock[2];
...
{
    if ( (FireSuperProjectileChunkD(Other) == None) && ((Physics == PHYS_Falling) || (Other != Instigator)) )
    {
