class SeekerGhostBall extends Gasbag;

event PostBeginPlay()
{
	Super.PostBeginPlay();
	MyAmmo.ProjectileClass = class'SeekerGhostballProjectile';
}
...
simulated function PlayDying(class<DamageType> DamageType, vector HitLoc)
{
    ...
    bTearOff = true;
    bPlayedDeath = true;
    Spawn(class'XEffects.ShockCombo'); //replace xEmitter with the class of the effect you want, for example: class'ShockComboCore' 
...
defaultproperties
{
     ...
     PrePivot=(X=20.000000,Y=0.000000,Z=-5.000000)
     Mass=1400.000000
     drawscale=20
     bDynamicLight=True
     LightType=LT_Steady
