class Magister extends Monster;
...
defaultproperties
{
     ...
     DeathSound(0)=Sound'fpsMonsterPack.roardie'
     DeathSound(1)=Sound'fpsMonsterPack.roardie'
     DeathSound(2)=Sound'fpsMonsterPack.roardie'
     DeathSound(3)=Sound'fpsMonsterPack.roardie'
     ChallengeSound(0)=Sound'fpsMonsterPack.horrorfinal2'
     ChallengeSound(1)=Sound'fpsMonsterPack.horrorfinal2'
     ChallengeSound(2)=Sound'fpsMonsterPack.horrorfinal2'
     ChallengeSound(3)=Sound'fpsMonsterPack.horrorfinal2'
     FireSound=SoundGroup'WeaponSounds.RocketLauncher.RocketLauncherFire'
     AmmunitionClass=Class'fpsMonsterPack.MagisterAmmo'
     ScoringValue=10
     bCanFly=True
     ...
     Skins(0)=Texture'fpsMonTex.Skins.Magister'
     Skins(1)=Texture'fpsMonTex.Skins.Magister'
