class MilkGlob_EffectChocolate extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorScale(1)=(RelativeTime=0.750000,Color=(G=64,R=128))
         ColorScale(2)=(RelativeTime=1.000000,Color=(G=64,R=128))
         MaxParticles=25
     ...
     End Object
     Emitters(0)=SpriteEmitter'fpsMonsterPack.MilkGlob_EffectChocolate.SpriteEmitter0'
     ...
     End Object
     Emitters(1)=SpriteEmitter'fpsMonsterPack.MilkGlob_EffectChocolate.SpriteEmitter1'
     ...
     End Object
     Emitters(2)=SpriteEmitter'fpsMonsterPack.MilkGlob_EffectChocolate.SpriteEmitter2'
