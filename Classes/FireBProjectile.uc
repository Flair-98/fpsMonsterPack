...
// FireBProjectile
//=============================================================================
class FireBProjectile extends Projectile;
...
{
    if ( (FireBProjectile(Other) == None) && ((Physics == PHYS_Falling) || (Other != Instigator)) )
    {
        ...
        if ( speed > 200 )
        {
			...
			Spawn(class'fpsMonsterPack.FireExplosionz');
			}
        }
        Destroy();
    }
...
defaultproperties
{
     FlyingEffectClass=Class'FireFlameTrail'
     Bounces=5
     DamageAtten=10.000000
