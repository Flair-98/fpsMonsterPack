class MonstaProj extends Projectile config(fpsMonsterPack); 
...
simulated function PostBeginPlay()
{
    ...
    {
		SparkleTrail = Spawn(class'SkaarjSparklesINI', self);
...
defaultproperties
{
     ...
     MyDamageType=Class'fpsMonsterPack.DamTypeMonsta'
