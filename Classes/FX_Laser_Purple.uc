class FX_Laser_Purple extends Emitter
	notplaceable;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         ColorScale(0)=(Color=(B=255,G=128,R=210))
         ColorScale(1)=(RelativeTime=0.750000,Color=(B=255,G=64,R=180))
     ...
     End Object
     Emitters(0)=SpriteEmitter'FX_Laser_purple.SpriteEmitter1'

     Begin Object Class=BeamEmitter Name=BeamEmitter1
         BeamEndPoints(0)=(offset=(X=(Min=1200.000000,Max=1200.000000)),Weight=1.000000)
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=128,R=200))
         CoordinateSystem=PTCS_Relative
         MaxParticles=1
         StartLocationOffset=(X=-150.000000)
     ...
     End Object
     Emitters(1)=BeamEmitter'FX_Laser_purple.BeamEmitter1'
