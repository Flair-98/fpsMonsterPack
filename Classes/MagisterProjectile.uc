...
// rocket.
//=============================================================================
class MagisterProjectile extends Projectile;

var	MagisterTrail SmokeTrail;
...
simulated function PostBeginPlay()
{
	...
	{
		SmokeTrail = Spawn(class'MagisterTrail',self,,Location - 40 * Dir, Rotation);
...
defaultproperties
{
     ...
     ExplosionEffectClass=Class'fpsMonsterPack.MagisterExplosion'
     Team=255
     Speed=1300.000000
     ...
     LifeSpan=20.000000
     DrawScale=0.400000
     Skins(0)=FinalBlend'fpsMonTex.Weapons.evilfire'
     AmbientGlow=96
     bUnlit=False
     SoundVolume=255
