class MilkGlobExplosion extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         MeshSpawningStaticMesh=StaticMesh'fpsMonMesh.milk.ParticleSphere'
     ...
     End Object
     Emitters(0)=SpriteEmitter'fpsMonsterPack.MilkGlobExplosion.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000)
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=255,G=255,R=255,A=190))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=60
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(1)=SpriteEmitter'fpsMonsterPack.MilkGlobExplosion.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         AutomaticInitialSpawning=False
         UseVelocityScale=True
         ColorScale(1)=(RelativeTime=0.330000,Color=(B=255,G=255,R=255,A=100))
         ColorScale(2)=(RelativeTime=0.660000,Color=(B=255,G=255,R=255,A=255))
         ColorScale(3)=(RelativeTime=1.000000)
         FadeInEndTime=0.100000
         MaxParticles=150
         StartLocationShape=PTLS_Sphere
     ...
     End Object
     Emitters(2)=SpriteEmitter'fpsMonsterPack.MilkGlobExplosion.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         VelocityScale(3)=(RelativeTime=1.000000)
     End Object
     Emitters(3)=SpriteEmitter'fpsMonsterPack.MilkGlobExplosion.SpriteEmitter3'

     Begin Object Class=MeshEmitter Name=MeshEmitter0
         StaticMesh=StaticMesh'fpsMonMesh.milk.ExplosionRing'
     ...
     End Object
     Emitters(4)=MeshEmitter'fpsMonsterPack.MilkGlobExplosion.MeshEmitter0'

     Begin Object Class=MeshEmitter Name=MeshEmitter1
         StaticMesh=StaticMesh'fpsMonMesh.milk.ExplosionSphere'
         RenderTwoSided=True
         UseParticleColor=True
         UseColorScale=True
         FadeOut=True
     ...
     End Object
     Emitters(5)=MeshEmitter'fpsMonsterPack.MilkGlobExplosion.MeshEmitter1'
     ...
     End Object
     Emitters(6)=SpriteEmitter'fpsMonsterPack.MilkGlobExplosion.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter5
         ...
         LifetimeRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(7)=SpriteEmitter'fpsMonsterPack.MilkGlobExplosion.SpriteEmitter5'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter6
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(8)=SpriteEmitter'fpsMonsterPack.MilkGlobExplosion.SpriteEmitter6'
     ...
     End Object
     Emitters(9)=MeshEmitter'fpsMonsterPack.MilkGlobExplosion.MeshEmitter2'
